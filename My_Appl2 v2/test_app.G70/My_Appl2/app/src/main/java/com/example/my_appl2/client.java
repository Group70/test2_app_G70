...
public class client extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //declaration button
        Button btnadd= findViewById(R.id.btnajouterclient);
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               my_db.AjouterClient(nom.getText().toString(),prenom.getText().toString(),phone.getText().toString(),gmail.getText().toString(),adress.getText().toString());
                nom.setText("");prenom.setText("");phone.setText("");gmail.setText("");adress.setText("");
                Toast.makeText(client.this, "save done ", Toast.LENGTH_SHORT).show();
